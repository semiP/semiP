			...
			<tr>
				<td>
					<table width="100%" style="text-align:center;">
						...
						<tr>
							<td class="board-titlebar" width="15%">날짜</td>
							<td class="board-titlebar" width="15%">구분</td>
							<td class="board-titlebar" width="55%">글제목</td>
							<td class="board-titlebar" width="15%">작성자</td>
						</tr>
						<tr><td colspan="4" bgcolor="#cccccc" height="1"></td></tr>
	<!-- 게시물 하나씩 iterator 시작 -->
						<tr>
							<td class="board-titlebar" width="15%">2017/11/10</td>
							<td class="board-titlebar" width="15%">[주문/배송]</td>
							<td class="board-titlebar" width="55%">이거 배송 하루만에 되나요</td>
							<td class="board-titlebar" width="15%">돈쓴사람</td>
						</tr>
						<tr><td colspan="4" bgcolor="#f2f2f2" height="1"></td></tr>
						<tr>
							<td class="board-titlebar" width="15%">2017/11/10</td>
							<td class="board-titlebar" width="15%"></td>
							<td class="board-titlebar" width="55%"><img src="/semiP/assets/images/board-icon/reply.gif">그럴 수도 있겠네요</td>
							<td class="board-titlebar" width="15%">관리자</td>
						</tr>
	<!-- 게시물 하나씩 iterator 끝 -->																
						<tr><td colspan="4" bgcolor="#cccccc" height="1"></td></tr>
						<tr>
