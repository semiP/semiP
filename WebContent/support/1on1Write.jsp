...
<table width="100%">
	...
	<tr> <!-- value에 inquiry.inquiry_subject / mypage.inquiry_subject 중 뭐가맞는지 확인해보기 -->
		...
		<input type="text" style="width:90%;" placeholder="제목을 입력해주세요" value="<s:property value='inquiry.inquiry_subject'/>"></td>
	...
	<tr>
		<td class="board-titlebar">
			<textarea style="width:90%; height:200px; resize:none;" placeholder="내용을 입력해주세요" value="<s:property value='inquiry.inquiry_content'/>"></textarea>
		</td>
	</tr>
	<tr><td bgcolor="#cccccc" height="1"></td></tr>
	<tr>
